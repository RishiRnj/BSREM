...
const LearningGadget = () => {
  const { user } = useContext(AuthContext);
  const userId = user?.id;
  const isAuthenticated = !!user;
  const [activeSwitch, setActiveSwitch] = useState('Donate Gadgets to the Community Store.');
                ...
                <div>
                    <Form className='switch-container'>
                        <Form.Check
                            ...
                            label={<span className={activeSwitch === "Donate Gadgets to the Community Store." ? "text-dark" : "text-muted"}>Donate Gadgets to the Community Store.</span>}
                            checked={activeSwitch === "Donate Gadgets to the Community Store."}
                            onChange={() => handleSwitchClick("Donate Gadgets to the Community Store.")}
                        />
                ...
                <div>
                    <Form className='switch-container'>
                        <Form.Check
                            ...
                            label={<span className={activeSwitch === "Find those, who need Learning Gadget." ? "text-dark" : "text-muted"}>Find those, who need Learning Gadget.</span>}
                            checked={activeSwitch === "Find those, who need Learning Gadget."}
                            onChange={() => handleSwitchClick("Find those, who need Learning Gadget.")}
                        />
                    </Form>
                </div>
