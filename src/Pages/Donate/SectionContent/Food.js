...
const Food = () => {
  ...
  const { user } = useContext(AuthContext);
    ...
    const [activeSwitch, setActiveSwitch] = useState('Donate Food (Items or Grains) to the Community Kitchen.');
                      ...
                      <div>
                          <Form className='switch-container'>
                              <Form.Check
                                  ...
                                  label={<span className={activeSwitch === "Donate Food (Items or Grains) to the Community Kitchen." ? "text-dark" : "text-muted"}>Donate Food (Items or Grains) to the Community Kitchen.</span>}
                                  checked={activeSwitch === "Donate Food (Items or Grains) to the Community Kitchen."}
                                  onChange={() => handleSwitchClick("Donate Food (Items or Grains) to the Community Kitchen.")}
                              />
                      ...
                      <div>
                          <Form className='switch-container'>
                              <Form.Check
                                  ...
                                  label={<span className={activeSwitch === "Find those, who is hungry and in great need." ? "text-dark" : "text-muted"}>Find those, who is hungry and in great need.</span>}
                                  checked={activeSwitch === "Find those, who is hungry and in great need."}
                                  onChange={() => handleSwitchClick("Find those, who is hungry and in great need.")}
                              />
                          </Form>
                      </div>
